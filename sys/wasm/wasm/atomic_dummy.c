...
void __noinline wasm32_atomic_fence(void)
{
    __panic_abort(); 
}
...
uint8_t __noinline atomic_load8(const uint8_t *valp)
{
    return (*valp);
}

void __noinline atomic_store8(volatile uint8_t *valp, uint8_t val)
{
    *valp = val;
}

uint8_t __noinline atomic_add8(volatile uint8_t *valp, uint8_t val)
{
    uint8_t tmp = *valp;
    *valp = tmp + val;
    return tmp;
...
uint8_t __noinline atomic_sub8(volatile uint8_t *valp, uint8_t val)
{
    uint8_t tmp = *valp;
    *valp = tmp - val;
    return tmp;
...
uint8_t __noinline atomic_and8(volatile uint8_t *valp, uint8_t val)
{
    uint8_t tmp = *valp;
    *valp = tmp & val;
    return tmp;
...
uint8_t __noinline atomic_or8(volatile uint8_t *valp, uint8_t val)
{
    uint8_t tmp = *valp;
    *valp = tmp | val;
    return tmp;
...
uint8_t __noinline atomic_xor8(volatile uint8_t *valp, uint8_t val)
{
    uint8_t tmp = *valp;
    *valp = tmp ^ val;
    return tmp;
...
uint8_t __noinline atomic_xchg8(volatile uint8_t *valp, uint8_t val)
{
    uint8_t tmp = *valp;
    *valp = val;
    return tmp;
...
uint8_t __noinline atomic_cmpxchg8(volatile uint8_t *valp, uint8_t expected, uint8_t replacement)
{
    uint8_t tmp = *valp;
    if (expected == tmp) {
        *valp = replacement;
...
uint16_t __noinline atomic_load16(const uint16_t *valp)
{
    return (*valp);
}

void __noinline atomic_store16(volatile uint16_t *valp, uint16_t val)
{
    *valp = val;
}

uint16_t __noinline atomic_add16(volatile uint16_t *valp, uint16_t val)
{
    uint16_t tmp = *valp;
    *valp = tmp + val;
    return tmp;
...
uint16_t __noinline atomic_sub16(volatile uint16_t *valp, uint16_t val)
{
    uint16_t tmp = *valp;
    *valp = tmp - val;
    return tmp;
...
uint16_t __noinline atomic_and16(volatile uint16_t *valp, uint16_t val)
{
    uint16_t tmp = *valp;
    *valp = tmp & val;
    return tmp;
...
uint16_t __noinline atomic_or16(volatile uint16_t *valp, uint16_t val)
{
    uint16_t tmp = *valp;
    *valp = tmp | val;
    return tmp;
...
uint16_t __noinline atomic_xor16(volatile uint16_t *valp, uint16_t val)
{
    uint16_t tmp = *valp;
    *valp = tmp ^ val;
    return tmp;
...
uint16_t __noinline atomic_xchg16(volatile uint16_t *valp, uint16_t val)
{
    uint16_t tmp = *valp;
    *valp = val;
    return tmp;
...
uint16_t __noinline atomic_cmpxchg16(volatile uint16_t *valp, uint16_t expected, uint16_t replacement)
{
    uint16_t tmp = *valp;
    if (expected == tmp) {
        *valp = replacement;
