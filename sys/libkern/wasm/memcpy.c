...
void arch_memcpy(void * _Nonnull dst, const void * _Nonnull src, size_t len)
{
	// just panic if this function is left within the binary at runtime.
	__panic_abort();
}
...
// HEAPU8.set()
void* emscripten_memcpy_big(void *restrict dest, const void *restrict src, size_t n) __WASM_IMPORT(emscripten, memcpy_big);
#endif
